export const translations: Translation[] = [
  { key: 'arabicButton', en: 'Arabic', ar: 'English' },
  { key: 'annualReport', en: 'Annual report', ar: 'التقرير السنوي' },
  { key: 'disciplinedGrowth', en: 'Disciplined growth', ar: 'نمو منضبط' },
  { key: 'diversifiedReturns', en: 'Diversified Returns', ar: 'عوائد متنوعة' },
  { key: 'themeOfYear', en: 'Theme of the Year', ar: 'موضوع العام' },

  // Slide panel texts
  {
    key: 'slideHeading1',
    en: 'Disciplined growth',
    ar: 'نمو منضبط'
  },
  {
    key: 'slideHeading2',
    en: 'Diversified Returns',
    ar: 'عوائد متنوعة'
  },
  {
    key: 'slideParagraph1',
    en: 'This year\'s theme focuses on driving innovation while maintaining growth\nto achieve more goals next year.',
    ar: 'يركز موضوع هذا العام على دفع الابتكار مع الحفاظ على النمو\nلتحقيق المزيد من الأهداف في العام القادم.'
  },
  {
    key: 'slideParagraph2',
    en: 'This year\'s theme focuses on driving innovation while maintaining sustainable growth. We are committed to creating long-term value through strategic investments. Lorem ipsum dolor sit amet, consectetur adipisicing elit. Eius a illo atque at. Maiores quod odio corporis ipsam pariatur incidunt?',
    ar: 'يركز موضوع هذا العام على دفع الابتكار مع الحفاظ على النمو المستدام. نحن ملتزمون بخلق قيمة طويلة الأجل من خلال الاستثمارات الاستراتيجية. لوريم إيبسوم دولور سيت أميت، كونسيكتيتور أديبيسيسينغ إيليت. إيوس أ إيلو أتكو أت. مايوريس كوود أوديو كوربوريس إبسام بارياتور إنسيدونت؟'
  },
  {
    key: 'slideParagraph3',
  ...
  { key: 'yearInReview', en: 'Year In Review', ar: 'عام في مراجعة' },
  { key: 'investmentCase', en: 'Investment Case', ar: 'حالة الاستثمار' },
  { 
    key: 'subHeaderTitle', 
    en: 'Driving sustainable value through strategic excellence', 
    ar: 'دفع القيمة المستدامة من خلال التميز الاستراتيجي' 
  },
  { 
    key: 'subHeaderDescription', 
    en: 'Our commitment to disciplined growth and diversified returns continues to strengthen our market position. Through strategic investments and operational efficiency, we have consistently delivered value to our stakeholders while maintaining a strong focus on long-term sustainability.', 
    ar: 'يواصل التزامنا بالنمو المنضبط والعوائد المتنوعة تعزيز مكانتنا في السوق. من خلال الاستثمارات الاستراتيجية والكفاءة التشغيلية، قدمنا باستمرار قيمة لأصحاب المصلحة مع الحفاظ على تركيز قوي على الاستدامة طويلة الأجل.' 
  },
    { 
    key: 'awardsTitle', 
   ...
   { 
    key: 'certificationsTitle', 
    en: 'Certifications and Standards', 
    ar: 'الشهادات والمعايير' 
  },
  { 
    key: 'cert1', 
    en: 'ISO 37301 Compliance Management System Certification', 
    ar: 'شهادة نظام إدارة الامتثال ISO 37301' 
  },
  { 
    key: 'cert2', 
    en: 'ISO/IEC 27001:2022 Information Security Certification', 
    ar: 'شهادة أمن المعلومات ISO/IEC 27001:2022' 
  },
  { 
    key: 'cert3', 
    en: 'PCI DSS v4.0 Certification for Payment Card Data Security', 
    ar: 'شهادة PCI DSS v4.0 لأمن بيانات بطاقات الدفع' 
  },

   { 
    key: 'sustainabilityTitle', 
    en: 'Sustainability Review', 
    ar: 'مراجعة الاستدامة' 
  },
  { 
    key: 'sustainabilityApproach', 
    en: 'Our Sustainability Approach', 
    ar: 'نهجنا في الاستدامة' 
  },
  { 
    key: 'sustainabilityApproachDesc', 
    en: 'We are committed to embedding sustainability across our operations, driving meaningful impact through responsible practices and strategic initiatives that align with national priorities and global standards.', 
    ar: 'نحن ملتزمون بدمج الاستدامة في جميع عملياتنا، وتحقيق تأثير ملموس من خلال الممارسات المسؤولة والمبادرات الاستراتيجية التي تتوافق مع الأولويات الوطنية والمعايير العالمية.' 
  },
  { 
    key: 'sustainabilityPriorities', 
    en: 'Our Sustainability Priorities', 
    ar: 'أولوياتنا في الاستدامة' 
  },
  { 
    key: 'sustainabilityPrioritiesDesc', 
    en: 'Our sustainability priorities focus on three key pillars: environmental stewardship, social responsibility, and governance excellence. These pillars guide our decisions and shape our long-term value creation strategy.', 
    ar: 'تركز أولوياتنا في الاستدامة على ثلاث ركائز رئيسية: الرعاية البيئية، والمسؤولية الاجتماعية، والتميز في الحوكمة. توجه هذه الركائز قراراتنا وتشكل استراتيجيتنا لخلق قيمة طويلة الأجل.' 
  },
  { 
    key: 'sustainabilityPrioritiesCategories', 
  ...
  { 
    key: 'visionText', 
    en: 'Deliver on sustainability commitments, align with national priorities, and drive meaningful social impact that creates lasting value', 
    ar: 'الوفاء بالتزامات الاستدامة، والتوافق مع الأولويات الوطنية، وتحقيق تأثير اجتماعي ملموس يخلق قيمة دائمة' 
  },
  { 
    key: 'mission', 
    en: 'Mission', 
  ...
  { 
    key: 'missionText', 
    en: 'Promote sustainability in how we operate, finance, and engage with our people, customers, communities, and shareholders', 
    ar: 'تعزيز الاستدامة في طريقة عملنا وتمويلنا وتفاعلنا مع موظفينا وعملائنا ومجتمعاتنا ومساهمينا' 
  },
  { 
  ...
  { 
    key: 'pillar1Title', 
    en: 'Sustain responsible operations and transparency', 
    ar: 'استدامة العمليات المسؤولة والشفافية' 
  },
  { 
    key: 'pillar1Item1', 
    en: 'Foster sustainability across operations supporting efficiency and performance', 
    ar: 'تعزيز الاستدامة في العمليات لدعم الكفاءة والأداء' 
  },
  { 
    key: 'pillar1Item2', 
    en: 'Ensure clear and consistent reporting aligned with sustainability standards', 
    ar: 'ضمان تقارير واضحة ومتسقة تتوافق مع معايير الاستدامة' 
  },
  { 
    key: 'pillar2Title', 
    en: 'Drive social impact and economic development', 
    ar: 'دفع التأثير الاجتماعي والتنمية الاقتصادية' 
  },
  { 
    key: 'pillar2Item1', 
    en: 'Strengthen initiative-based community and customer engagement', 
    ar: 'تعزيز المشاركة المجتمعية والعملاء القائمة على المبادرات' 
  },
  { 
    key: 'pillar2Item2', 
    en: 'Enable SMEs growth through localization and capability development', 
    ar: 'تمكين نمو المؤسسات الصغيرة والمتوسطة من خلال التوطين وتطوير القدرات' 
  },
  { 
    key: 'pillar2Item3', 
    en: 'Support talent development and employee wellbeing', 
    ar: 'دعم تطوير المواهب ورفاهية الموظفين' 
  },
  { 
    key: 'pillar3Title', 
    en: 'Uphold sustainable finance offering', 
    ar: 'الحفاظ على عرض التمويل المستدام' 
  },
  { 
    key: 'pillar3Item1', 
    en: 'Support customers in their sustainability journey with tailored financing solutions', 
    ar: 'دعم العملاء في رحلتهم نحو الاستدامة بحلول تمويلية مخصصة' 
  },
  { 
    key: 'pillar3Item2', 
    en: 'Assess sustainability-linked opportunities', 
    ar: 'تقييم الفرص المرتبطة بالاستدامة' 
  },
